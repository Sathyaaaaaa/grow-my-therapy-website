export default function PrivacyPolicy() {
    ...
    <div className="bg-[#FAF7F1] min-h-screen p-6 md:p-12 text-gray-800">
      <div className="mb-10">
        <img
          ...
          alt="Logo"
          className="space-y-6 w-56 md:w-84"
        />
      </div>

      <div className="flex flex-col md:flex-row gap-16 md:items-start">
        <div className="md:w-1/2 space-y-6">
          <h1 className="text-4xl font-sans font-serif text-gray200">Privacy Policy</h1>
          <div>
            <h2 className="text-lg font-semibold mb-5 font-serif font-sans">Contact Us</h2>
  ...
  This website is hosted by Squarespace. Squarespace collects personal data when you visit this website, including:
            ...
            <ul className="list-disc list-inside mt-2 font-sans font-serif text-gray-600">
              <li>Information about your browser, network and device</li>
              <li>Web pages you visited prior to coming to this website</li>
              <li>Your IP address</li>
            </ul>
            <p className="mt-2 text-gray-600 font-sans font-serif ">
              Squarespace needs the data to run this website, and to protect and improve its platform and services. Squarespace analyzes the data in a de-personalized form.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-bold mb-1  font-sans font-serif ">Cookies</h2>
            <p className="text-gray-600 font-sans font-serif ">
          ...
          <div>
            <h2 className="text-lg font-bold mb-1 font-serif font-serif">Fonts</h2>
            <p className="text-gray-600 font-sans font-serif ">
            ...
            <ul className="list-disc list-inside mt-2 text-gray-600 font-sans font-serif ">
      ...
      <footer className="bg-[#FAF7F1] text-gray-800 text-center py-12 px-4 mt-12">
        <div className="space-y-4 max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-500 font-sans font-serif">28175 Haggerty Rd, Novi, MI 48377</p>
          <div className="space-x-4">
            <a href="/" className="text-blue-600 hover:underline">Home</a>
            <a href="/privacy-policy" className="text-blue-600 hover:underline">Privacy Policy</a>
            <a href="/good-faith-estimate" className="text-blue-600 hover:underline">Good Faith Estimate</a>
            <a href="/client-portal" className="text-blue-600 hover:underline">Client Portal</a>
          </div>
          <p className="text-xl text-gray-500 font-serif font-sans mt-4">
